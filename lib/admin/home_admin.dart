...
import 'package:zerohunger_logistics_app/admin/add_food.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            Center(child: Text("Home Admin",style: AppWidget.HeadTextFeildStyle(),),),
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      child: Image.asset("images/fruits.jpeg",height: 100.0,width: 100.0,fit: BoxFit.cover,),),
                      SizedBox(width: 30.0,),
